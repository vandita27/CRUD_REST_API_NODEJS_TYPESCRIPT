...
var processDeleteUser = function (userId, userModelValidation) { return __awaiter(void 0, void 0, void 0, function () {
    var deleteUser_1, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, User_1.default.deleteOne({
                        _id: userId,
                    })];
            case 1:
                deleteUser_1 = _a.sent();
                return [2 /*return*/, deleteUser_1];
            case 2:
                error_2 = _a.sent();
                console.log(error_2);
                return [3 /*break*/, 3];
...
var createUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userModelValidation, isUsernameAvailable, newUser, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
...
var getUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userIdValidation, userDetails, error_6;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
...
var deleteUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var userModelValidation, isUsernameValid, deleteUser_2, error_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
            ...
            case 3:
                ...
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, processDeleteUser(isUsernameValid._id, userModelValidation)];
            case 5:
                deleteUser_2 = _a.sent();
                if (deleteUser_2) {
                    res.status(201).json({
                        deleteUser: deleteUser_2,
                    });
                }
                else {
                    return [2 /*return*/, next(res.status(400).json({
